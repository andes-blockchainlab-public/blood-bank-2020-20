...
const AdverseEffect = ({volver}) => {
    ...
    const handleSubmit = async (e) => {
        ...
        let res = await createAdverseEvent(form, session)
    ...
    return (
        <div className="adverse-detail">
            ...
            <div className="opciones">
                <button
                    className="btn-acciones btn-header">Reportar
                    evento adverso
                </button>
            </div>
            <div className="informacion-enviar">
                ...
                <form className="form-envio" onSubmit={handleSubmit}>
                    <div className="grilla-campos">
                        ...
                        <div className="columna-campo">
                            <label className="campo-texto" htmlFor="symptom">Sintomas reportados</label>
                            <input required className="input-iniciar" name="symptom" type="text"
                                   value={form.symptom}
                                   maxLength={150}
                                   onChange={handleChange}/>
                        </div>
                    ...
                    <button type="submit"
                            className="btn-redondo boton-enviar">Reportar</button>
                </form>
            </div>
